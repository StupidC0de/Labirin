              ...
              <div class="col-lg-12">
                <div class="p-5">
                  ...
                  <form class="user" action="{{ route('register') }}" method="post">
                    ...
                    <div class="form-group">
                      <input name="email" type="text" class="form-control form-control-user"  placeholder="E-mail">
                    </div>
                    <div class="form-group">
                  ...
                  <div class="text-center">
                    <a class="small" href="{{ route('login-page') }}">Have an Account? Login here</a>
                  </div>
                </div>
              </div>
            </div>
